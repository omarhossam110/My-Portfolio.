              ...
              <div className={`about__info-padding`}>
                ...
                <div className={`about__content`}>
                  <div className={`about__info-description`}>
                    ...
                    <span className={`about__info-span col-xs-4`}>1/8/1998</span>
                  </div>
                  ...
                  <div className={`about__info-description`}>
                    ...
                    <span className={`about__info-span col-xs-4`}>Cairo, Egypt</span>
                  </div>
                  ...
                  <div className={`about__info-description`}>
                    ...
                    <span className={`about__info-span col-xs-4`}>Available</span>
                  </div>
                  ...
                  <div className={`about__info-description`}>
                    ...
                    <span className={`about__info-span col-xs-4`}>01004938289</span>
                  </div>
                </div>
              </div>
            </div>
